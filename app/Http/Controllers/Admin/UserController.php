...
// // Método actualizado para guardar o editar el usuario
// // public function updateUserDetails(Request $request, $id = null) {
// //     // Session::put('page', 'update-user-details');
...
// //             'user_code' => 'required|unique:users,code,' . $id,  // Código único
// //             'user_name' => 'required|regex:/^[\p{L}\s]+$/u',     // Solo letras y espacios
// //             'user_email' => 'required|email|unique:users,email,' . $id,  // Correo único
// //             'user_position' => 'required',                       // Puesto requerido
// //             'mobile' => 'required|numeric',                 // Teléfono numérico
// //             'password' => $id ? 'nullable|min:6' : 'required|min:6',  // Contraseña obligatoria si es nuevo
// //             'status' => 'required'
// //         ];
...
// //             'name.regex' => 'El campo nombre solo acepta letras y espacios, no números ni caracteres especiales',
...
// //         // Si hay ID, es una actualización, si no, es un nuevo usuario
// //         if ($id) {
// //             $user = User::find($id);
// //         } else {
// //             $user = new User;
...
// //         // Asignar los datos al modelo de usuario
...
// //         return redirect('/admin/user-list')->with('success_message', 'Usuario guardado correctamente.');
// //     }

// //     return redirect()->back()->with('error_message', 'Solicitud no válida');
// // }
